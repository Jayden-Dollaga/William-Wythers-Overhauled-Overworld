#!/usr/bin/env python3
"""
Round 4, Category 7: Fix remaining IntProvider y_spread and xz_spread
Convert integer values to IntProvider objects
"""
import json
import os
import subprocess
...
print("Scanning for integer spread values in random_offset...\n")
affected_files = []
    ...
    try:
        ...
        if fix_random_offset(data):
            ...
            subprocess.run(['git', 'commit', '-m',
                          f'fix: convert integer spreads to IntProvider — {os.path.basename(filepath)}'],
                          capture_output=True)
